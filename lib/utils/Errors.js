...
class MissingMiCloudCredentials extends Error {
  constructor() {
    super(`Missing information required to connect to the MiCloud! Please specify either MiCloud username and password or tokens (serviceToken, userId, ssecurity)!`);
  }
}
